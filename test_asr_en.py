...
class EnglishAsrClient:
    """Client that connects to English ASR server only"""
    ...
    def __init__(self,
        ...
        if not en_connected:
            print("Failed to connect to English ASR server.", file=sys.stderr)
            return
    ...
    def record_and_send_audio(self):
        ...
        try:
            ...
            print("Recording and sending audio to English ASR server...")
            ...
            while self.is_running:
                ...
                # Send the audio chunk to the queue
                if self.en_ws:
                ...
                if chunk_count % 100 == 0:
                    ...
                    print(f"Audio status - chunks sent: {chunk_count}, EN queue: {en_queue_size}")
    ...
    def start_playback(self):
        """Start playing audio file and sending to ASR server"""
    ...
    def play_and_send_audio(self):
        """Play audio file and send data to ASR server"""
        try:
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description="English ASR client")
...
if __name__ == "__main__":
    try:
        ...
        # Create and start the English ASR client
        with EnglishAsrClient(en_asr_url=args.en_url,
                           audio_device=args.device,
                           use_pulse=args.pulse,
                           output_wav_file=args.output,
                           input_file=args.input_file) as client:
            
            print("\nEnglish ASR client is running. Press Ctrl+C to exit.")
